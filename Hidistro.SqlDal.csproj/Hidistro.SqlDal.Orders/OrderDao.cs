    ...
    public class OrderDao
    {
        ...
        public decimal GetRebeateCommission(string OrderID)
        {
            ...
            try
            {
                ...
                string SelectQuery = string.Format(" SELECT ProductID FROM [shop2.haiwangcn.cn].[dbo].[Hishop_OrderItems]where OrderId= '{0}'", OrderID);
                ...
                if (!string.IsNullOrEmpty(ProductID))
                {
                    try
                    { 
                        string SelectQuery2 = string.Format(" SELECT RebeateCommission FROM [shop2.haiwangcn.cn].[dbo].[vw_Hishop_BrowseProductList] WHERE ProductId= '{0}'", ProductID);
