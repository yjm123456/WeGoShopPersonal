...
namespace Hidistro.ControlPanel.Store
{
	public static class ManagerHelper
	{
        ...
        public static ManagerInfo CheckAdminName(string userName)
        {
            return (new MessageDao()).CheckAdminName(userName);
        }
        public static ManagerInfo GetManageByBusId(string BusinessId)
        {
            return (new MessageDao()).GetManageByBusId(BusinessId);
        }
        public static void setShopUserValue()
        {
             new MessageDao().setShopUserValue();
        }
