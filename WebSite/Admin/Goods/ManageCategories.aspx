...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server">
        <input type="text" id="netId" runat="server" class="hide" />
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            ...
                            <a class="er" style="position: relative" href="javascript:void(0)" tsrc="<%# this.netId.Value %>/admin/shop/QrCodeCreate.aspx?url=http://<%#Globals.DomainName+"/ProductList.aspx%3FcategoryId="+Eval("CategoryId")+"&Name="+Eval("Name")%>" onclick="winqrcode('<%#"http://"+Globals.DomainName+"/ProductList.aspx?categoryId="+Eval("CategoryId")%>','<%#Eval("Name")%>');"></a>
    ...
    <script type="text/javascript">
        ...
        function winqrcode(url, name) {
            var netParam = $("[id$=netId]").val();
            var srcname = netParam + "/Admin/shop/Qrcodecreate.aspx?url=" + url + "&Name=" + name;
