...
<script type="text/javascript">
    ...
    function winqrcode() {
        ...
        var gameid = url.split('gamid=')[1];
        gameid = gameid.split("&")[0];
        var netParam = $("[id$=netId]").val();
        var srcname = netParam + "/Admin/shop/Qrcodecreate.aspx?url=" + url + "&Name=" + gameid;
        ...
        <div class="form-horizontal clearfix">
            ...
            <div class="form-group setmargin">
                ...
                <div class="form-inline col-xs-9">
                    ...
                    <asp:TextBox ID="netId" runat="server" style="display:none" ></asp:TextBox>
                    积分/次
