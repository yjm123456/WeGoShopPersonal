                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="text-align: center; width: 30%;">                                           
                                            <span class="qr">
                                                  <img src="../images/qrcode.png" style="height: 26px; cursor: pointer;" onclick="winqrcode('<%#"http://"+Globals.DomainName+"/VShop/CouponDetails.aspx?CouponId="+Eval("VoteId")%>','<%#Eval("VoteName")%>');" />
