...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="/admin/js/ZeroClipboard.min.js"></script>
    <%--必须在echarts.js前引用--%>
    ...
    <form runat="server" id="aspForm">
        <div class="shopuser clearfix">
            <div class="fl shopuser-img clearfix">
                ...
                <h2 class="fl">
                    <asp:Literal runat="server" ID="lbShopName"></asp:Literal>
                </h2>
            </div>
            <div class="shop-link fr">
                ...
                <div class="vechar">
                    <p>手机扫码访问：</p>
                    <img alt="加载中..." id="imagecode" src="" />
                    <p>
                        <input type="text" id='netId' name="netId" value='<%=netId %>' disabled="" style="display: none">
        ...
        <div class="data-shop">
            ...
            <div class="data-list clearfix">
                ...
                <div class="data-box fl">
                    <h4>售后订单</h4>
                    <p>
                        <%--<asp:Label  ID="lbServiceOrderQty2" runat="server">0</asp:Label>--%>
        ...
        <div class="shopdatatable clearfix">
            <div class="shopdatatable-left fl">
                <table class="table table-hover">
                    <caption>分销商佣金排名<p><span class="active">近7天</span><%--<span>30天</span>--%></p>
                    </caption>
                    <thead>
                        <tr>
                            <th>店铺名称</th>
            ...
            <div class="shopdatatable-right fr">
                <table class="table">
                    <caption>会员消费排名<p><span class="active">近7天</span><%--<span>30天</span>--%></p>
                    </caption>
                    <thead>
                        <tr>
                            <th>会员名</th>
            ...
            $(function () {
                ...
                $('.shop-link > a:last').click(function (event) {
                    if ($('.shop-link .vechar').css('display') == 'none') {
                        ...
                        var netParam = $("[id$=netId]").val();
                        var url = $("[id$=txtShopUrl]").val();
                        var srcname = '<%=netId %>' + "/Admin/shop/Qrcodecreate.aspx?url=" + '<%=showUrl %>' + "&Name=qrCodeDefault";
         $("#imagecode").attr('src', srcname);
